      ...
      if (!events) {
        events = [
          { 
            ...
            capacity: 50, participants: ['u_alex','u_meera'], status: 'completed', prize: 'Cash Prize ₹10,000', startDate: '2025-09-10', endDate: '2025-09-11', organizer: 'Organ Team', createdAt: Date.now() - 86400000 * 10, googleFormLink: 'https://forms.gle/q6bHtZvDAezw5M6d7' 
          },
          { 
            id: 'e2', 
            ...
            capacity: 40, participants: [], status: 'approved', prize: 'Certificates & goodies', startDate: '2025-10-02', endDate: '2025-10-02', organizer: 'Organ Team', createdAt: Date.now() - 86400000 * 3, googleFormLink: 'https://forms.gle/q6bHtZvDAezw5M6d7'
          },
          { 
            id: 'e3', 
            ...
            capacity: 100, participants: [], status: 'pending', prize: 'Top coders get swags', startDate: '2025-11-12', endDate: '2025-11-12', organizer: 'Organ Team', createdAt: Date.now() - 86400000 * 1, googleFormLink: 'https://forms.gle/q6bHtZvDAezw5M6d7'
          },
        ];
